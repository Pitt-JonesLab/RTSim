...
ConfigurableTimer::ConfigurableTimer(const NVM::Simulation::Config& conf) : remainingCycles(0) {
...
bool ConfigurableTimer::busy() const {
    return remainingCycles > 0;
}

void ConfigurableTimer::issue(Command cmd) { remainingCycles = 5; }