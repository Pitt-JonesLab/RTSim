...
std::unique_ptr<SubArray> makeSimpleSubArray(const NVM::Simulation::Config& conf) {
...
std::unique_ptr<Interconnect> makeSimpleInterconnect(const NVM::Simulation::Config& conf) {
...
std::unique_ptr<MemoryController> makeSimpleController(const NVM::Simulation::Config& conf) {
...
std::unique_ptr<NVM::Simulation::MemorySystem> NVM::Memory::makeSimpleSystem(const NVM::Simulation::Config& conf) {
